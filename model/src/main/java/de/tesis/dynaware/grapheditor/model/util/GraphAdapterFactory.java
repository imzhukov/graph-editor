...
public class GraphAdapterFactory extends AdapterFactoryImpl {
	...
	protected GraphSwitch<Adapter> modelSwitch =
		new GraphSwitch<Adapter>() {
			...
			@Override
			public Adapter caseGParameter(GParameter object) {
				return createGParameterAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.tesis.dynaware.grapheditor.model.GParameter <em>GParameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGParameterAdapter() {
		return null;
	}
