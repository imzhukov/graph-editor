...
public interface GNode extends GConnectable {
	 ...
	 * @see #setName(String)
	 * @see de.tesis.dynaware.grapheditor.model.GraphPackage#getGNode_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link de.tesis.dynaware.grapheditor.model.GNode#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
