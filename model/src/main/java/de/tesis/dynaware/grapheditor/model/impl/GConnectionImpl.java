 ...
 *   <li>{@link de.tesis.dynaware.grapheditor.model.impl.GConnectionImpl#getDbObjectId <em>Db Object Id</em>}</li>
...
public class GConnectionImpl extends GConnectableImpl implements GConnection {
	...
	public void setDbObjectId(int newDbObjectId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GCONNECTION__DB_OBJECT_ID, oldDbObjectId, dbObjectId));
	}
