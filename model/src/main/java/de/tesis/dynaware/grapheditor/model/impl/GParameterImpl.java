...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GParameter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class GParameterImpl extends MinimalEObjectImpl.Container implements GParameter {
	...
	protected EClass eStaticClass() {
		return GraphPackage.Literals.GPARAMETER;
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GPARAMETER__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GraphPackage.GPARAMETER__ID:
				return getId();
			case GraphPackage.GPARAMETER__TYPE:
				return getType();
